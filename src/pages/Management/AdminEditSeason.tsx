// src/pages/Management/AdminEditSeason.tsx
...
const AdminEditSeason: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (currentProfile) {
      ...
      if (currentConfiguredSeason) {
        ...
        navigate(`/console/admin/consoles/${profileId}`); // Go back
      }
    } else {
      console.error('Profile not found');
      navigate('/console/admin/consoles'); // Go back
    }
    setLoading(false);
    ...
    <div className="animate-fade-in">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate(`/console/admin/consoles/${profileId}`)}
...
export default AdminEditSeason;