...
const ConsoleMapAssignments: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Use the globally set active season
  ...
  return (
    <div className="space-y-4 animate-fade-in pb-16 h-[calc(100vh-8rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 pr-2">
